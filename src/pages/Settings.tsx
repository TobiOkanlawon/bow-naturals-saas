...
export default function Settings() {
  ...
  useEffect(() => {
    ...
    setForm((prev) => ({
      ...
      logoEmoji: (company as any).logo_emoji ?? (company.logoEmoji ?? prev.logoEmoji),
      primaryColor: (company.primaryColor ?? (company as any).primary_color) ?? prev.primaryColor,
      primaryDark: (company.primaryDark ?? (company as any).primary_dark) ?? prev.primaryDark,
      primaryLight: (company.primaryLight ?? (company as any).primary_light) ?? prev.primaryLight,
      sidebarGradientFrom: (company.sidebarGradientFrom ?? (company as any).sidebar_gradient_from) ?? prev.sidebarGradientFrom,
      sidebarGradientTo: (company.sidebarGradientTo ?? (company as any).sidebar_gradient_to) ?? prev.sidebarGradientTo,
      accentColor: (company.accentColor ?? (company as any).accent_color) ?? prev.accentColor,
        ...
        <div className="card p-6 space-y-6">
                  ...
                  {emojiOptions.map((emoji) => (
                    <button
                      ...
                      style={
                        form.logoEmoji === emoji
                          ? {
                              outline: `2px solid ${form.primaryColor}`,
          ...
          <div className="border-t border-gray-100 pt-6">
            ...
            <p className="text-xs text-gray-500 mb-4">
              These details will automatically appear on customer invoices when
              filled.
            </p>
            <div className="space-y-4">
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-xl">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Bow Naturals Ltd"
                  />
                </div>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Thank You Message (for invoice)
                </label>
                <textarea
                  ...
                  placeholder="Thank you for your order! We appreciate your business."
                />
                <p className="text-[10px] text-gray-400 mt-1">
                  This message appears at the bottom of every invoice
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="card p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              />
              <p className="text-xs text-gray-400 mt-1">
                This name will appear as the CEO in the system.
              </p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              />
              <p className="text-xs text-gray-400 mt-1">
                Login email for the CEO account.
              </p>
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, ceoPassword: e.target.value })
                }
                placeholder="Enter new password"
              />
              <p className="text-xs text-gray-400 mt-1">
                Change the CEO login password.
              </p>
            </div>
          </div>
          <div className="bg-amber-50 rounded-lg p-4 text-sm text-amber-800">
            <strong>Note:</strong> After changing credentials, log out and use
            the new email/password to log in. Staff emails and passwords can be
            managed in the Staff page.
          </div>
        </div>
      )}
              ...
              {colorPresets.map((preset) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${preset.from}, ${preset.primary})`,
                    }}
                  />
                </button>
              ))}
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, primaryDark: e.target.value })
                    }
                    className="w-10 h-10 rounded-lg border border-gray-200 cursor-pointer"
                  />
                  <input
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, sidebarGradientFrom: e.target.value })
                    }
                    className="w-10 h-10 rounded-lg border border-gray-200 cursor-pointer"
                  />
                  <input
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setForm({ ...form, sidebarGradientTo: e.target.value })
                    }
                    className="w-10 h-10 rounded-lg border border-gray-200 cursor-pointer"
                  />
                  <input
          ...
          <div className="card p-6">
            ...
            <div className="max-w-[260px] mx-auto rounded-xl overflow-hidden shadow-lg">
              <div
                className="p-4"
                style={{
                  background: `linear-gradient(180deg, ${form.sidebarGradientFrom}, ${form.sidebarGradientTo})`,
                }}
              >
